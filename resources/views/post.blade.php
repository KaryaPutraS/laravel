    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-5">
                ...
                <div class="card">
                    <div class="position-absolute px-3 py-2 p-3 " style="background-color:rgba(0, 0, 0, 0.7)">
                    ...
                    <div class="card-body">
                      ...
                      <p>
                        <small class="text-muted">
                        By: <a href="/post?author={{ $post->author->username }}" class="text-decoration-none"> {{ $post->author->name }}</a>
